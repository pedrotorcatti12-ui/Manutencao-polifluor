            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-3xl p-6 m-4 relative border border-gray-200 dark:border-gray-700 max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
                ...
                <div className="flex-1 overflow-y-auto mt-6 pr-2 -mr-2 space-y-4">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/50 p-3 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label className="text-xs font-bold uppercase text-gray-500 dark:text-gray-400">Data/Hora Solicitação</label>
                                <input 
                                    type="datetime-local" 
                                    value={currentTask.requestDate || currentTask.startDate || ''} 
                                    onChange={e => setCurrentTask({...currentTask, requestDate: e.target.value})} 
                                    className="w-full mt-1 form-input text-sm" 
                                />
                            </div>
                            <div>
                                <label className="text-xs font-bold uppercase text-gray-500 dark:text-gray-400">Início da Atividade</label>
                                <input 
                                    type="datetime-local" 
                            ...
                            <div>
                                <label className="text-xs font-bold uppercase text-gray-500 dark:text-gray-400">Conclusão</label>
                                <input 
                                    type="datetime-local" 
